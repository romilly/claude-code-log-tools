...
## Next Steps
1. ~~Update `docs/DESIGN.md` to reflect new tables and columns~~ Done
2. Add comprehensive tests for import logic (idempotency, filtering, summary capture, error handling)
3. Extract import logic from notebook into proper modules using hexagonal architecture and TDD
4. Experiment with queries to find failure patterns
